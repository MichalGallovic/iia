...
define('SWEETCAPTCHA_APP_ID', 214601); // your application id (change me)
define('SWEETCAPTCHA_KEY', 'acf6e1834e2f1f5ce109086eed27d7dc'); // your application key (change me)
define('SWEETCAPTCHA_SECRET', 'fb3b6e552e138d5a07479f94fb89843d'); // your application secret (change me)
define('SWEETCAPTCHA_PUBLIC_URL', 'http://vmxgallovicm.fei.stuba.sk/z4/sweetcaptcha.php'); // public http url to this file
